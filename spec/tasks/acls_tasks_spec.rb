describe 'Using rake tasks to add a user to groups for local group and acl manual testing and development', reset_provider: true do
  ...
  context 'when using acls:groups tasks' do
    ...
    # tasks only, and also because the testing of adding and removing of group
  ...
  #   before do
  #     Rake::Task['acls:testing:prepare'].invoke('preparetasktestuser')
  #
  #     wait_for_cmr
  #     reindex_permitted_groups
  #     wait_for_cmr
  ...
  #
  #   after do
  #     remove_members_response = cmr_client.remove_group_members(@provider_group_id, %w[preparetasktestuser], 'access_token_admin')
  #     # need to remove users added to Admin groups or ACLs are not set
  #     # properly for other tests
  #     remove_members_response = cmr_client.remove_group_members(@sys_group_id, %w[preparetasktestuser typical], 'access_token_admin')
  #     wait_for_cmr
  #     reindex_permitted_groups
  #     wait_for_cmr
  #     clear_cache
  ...
  #     puts "getting group #{@provider_group_id.inspect}"
  #     group_response = cmr_client.get_group(@provider_group_id, 'access_token_admin')
  #     puts "group_response: #{group_response.inspect}"
  #     members_response = cmr_client.get_group_members(@provider_group_id, 'access_token_admin')
  #     wait_for_cmr
  #
  #     expect(group_response.body['num_members']).to eq(3)
  #     expect(members_response.body).to eq(%w[typical testuser preparetasktestuser])
  #
  #     sys_group_response = cmr_client.get_group(@sys_group_id, 'access_token_admin')
  #     sys_members_response = cmr_client.get_group_members(@sys_group_id, 'access_token_admin')
  #     wait_for_cmr
  #
  #     expect(sys_members_response.body).to eq(%w[admin adminuser preparetasktestuser typical])
  #     expect(sys_group_response.body['num_members']).to eq(4)
  #   end
  # end
end
